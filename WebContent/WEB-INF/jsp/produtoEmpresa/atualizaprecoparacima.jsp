...
<display:table  class="displaytag.css" id="produtoEmpresa" export="true" name="${produtoEmpresaList}" pagesize="5" size="resultSize" requestURI="/produtoEmpresa/acrescimo">
