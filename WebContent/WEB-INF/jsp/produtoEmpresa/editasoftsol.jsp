...
<body>
	<div id="conteudo">
		<form id="produtoEmpresaForm" action="<c:url value="/produtoEmpresa/softsol/${produtoEmpresa.id }"/>" method="POST">
			<fieldset>
				<legend>Editar Produto da Empresa</legend>
				<img width="134" height="200" alt="edita" src="<c:url value="/imagens/paginas/edita.gif"/>">
				<p></p>
					<input type="hidden" name="produtoEmpresa.produto.id" value="${produtoEmpresa.id}"> 
