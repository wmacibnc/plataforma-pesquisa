...
<body>
	...
	<input id="buscaproduto" name="nome" />
		...
		<display:table class="displaytag.css" id="produto" export="true"
			name="${produtoList}" pagesize="5" size="resultSize"
			requestURI="/produto">
			<display:column property="id" title="Cód" sortable="true" />
			<display:column title="Subgrupo"><img src="<c:url value="/subgrupo/${produto.subgrupo.id}/imagem"/>" width="120" height="120" /></display:column>
