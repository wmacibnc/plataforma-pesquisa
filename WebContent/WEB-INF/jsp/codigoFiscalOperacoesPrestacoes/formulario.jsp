...
<body>
	...
	<div id="conteudo">
		<form id="codigoFiscalOperacoesPrestacoesForm" action="<c:url value="/codigoFiscalOperacoesPrestacoes"/>"	method="POST">
			
			<fieldset>
			
				<legend>Adicionar Codigo Fiscal de Operacoes e Prestacoes - CFOP</legend>
